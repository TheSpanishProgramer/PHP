  ...
  <body>
    ...
    <?php
      ...
      if (isset($_POST['alta'])){
        ...
        $altaCliente = "INSERT INTO `cliente` (`dni`, `nombre`, `direccion`, `telefono`) VALUES ('".$dni."','".$nombre."','".$direccion."','".$telefono."');";
      ...
      <table border="1">
        ...
        <form method="post" action="index.php">
          <tr>
            <td><input type="text" name="dni" value="<?= $dni ?>" style="background-color: grey; color: white"></td>
            <td><input type="text" name="nombre" value="<?= $nombre ?>" style="background-color: grey; color: white"></td>
            <td><input type="text" name="direccion" value="<?= $direccion ?>" style="background-color: grey; color: white"></td>
            <td><input type="text" name="telefono" value="<?=$telefono?>" style="background-color: grey; color: white"></td>            
            <td><input type="submit" name="aceptarCambios" value="ACEPTAR CAMBIOS"></td>            
          </tr>
        </form>
      <?php
