...
<body style="background-color: darksalmon">
  ...
  <div class="p-5">
    ...
    ?>
    <a href="crearLibro.php" class="btn btn-success"><i class="fas fa-user-plus mr-2"></i>Nuevo Libro</a>
        ...
        while ($fila = $stmt->fetch(PDO::FETCH_OBJ)) {
          echo <<<TXT
            <tr>
              ...
              <td>{$fila->isbn}</td>
              <td><img src="{$fila->portada}" class="img-thumbnail" width='50px' height='50px'/></td>
              <td>
