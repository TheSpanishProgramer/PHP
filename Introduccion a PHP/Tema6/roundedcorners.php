...
//marca de agua
$imagen2 =  imagecreatefromjpeg('marca.jpg');

$x = intval(imagesx($image)-imagesx($imagen2))/4;
$y = intval(imagesy($image)-imagesy($imagen2))/4;
$yy = intval(imagesy($image))/2;

imagecopymerge($image,$imagen2,0,0,0,0,604,49,25);
