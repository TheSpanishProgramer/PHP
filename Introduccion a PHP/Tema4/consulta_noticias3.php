...
<?PHP
   ...
   // Conectar con el servidor de base de datos
      $conexion = mysql_connect ("localhost","userp1","cursphp10")
         or die ("No se puede conectar con el servidor");

   // Seleccionar base de datos
      mysql_select_db ("userp1")
   ...
   // Enviar consulta
      ...
      if (isset($actualizar) && $categoria != "Todas")// si existe la variable actualizar y categorias es diferente de todas...
