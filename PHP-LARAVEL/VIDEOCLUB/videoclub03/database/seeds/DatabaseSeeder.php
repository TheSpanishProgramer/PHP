...
class DatabaseSeeder extends Seeder
{
    ...
    private $arrayUsuarios = array(
        array(
			'name' => 'usuario1',
			'email' => 'correo_prueba1@email.com',
			'password' => '1234',
		),
		array(
			'name' => 'usuario2',
			'email' => 'correo_prueba2@email.com',
			'password' => '1234',
        ),
        array(
			'name' => 'usuario3',
			'email' => 'correo_prueba3@email.com',
			'password' => '1234',
        ),
        array(
			'name' => 'usuario4',
			'email' => 'correo_prueba4@email.com',
			'password' => '1234',
        ),
        array(
			'name' => 'usuario5',
			'email' => 'correo_prueba5@email.com',
			'password' => '1234',
        ),
        array(
			'name' => 'usuario6',
			'email' => 'correo_prueba6@email.com',
			'password' => '1234',
        )
    );
}
